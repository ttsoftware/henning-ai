...
\*******************************************************/
	...
	Assuming "cserver.jar", "WinnerClient.class", and a directory "compevels/" is in the current directory, the competition server can be run with:
        $ java -jar cserver.jar -d complevels/ -c "java WinnerClient"
