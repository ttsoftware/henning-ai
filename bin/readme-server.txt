...
\*******************************************************/
    ...
    The -o <file> argument plays a log file. The -c and -l are ignored and the logfile pointed to by -o is replayed.
    ...
    * Important for Unix systems *
    ...
    The -Dsun.java2d.opengl=true option enables OpenGL hardware acceleration (see http://docs.oracle.com/javase/6/docs/technotes/guides/2d/flags.html).
